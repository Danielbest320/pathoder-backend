...
public class HorarioLocalBusinessLogicImpl implements HorarioLocalBusinessLogic {
    ...
    @Override
    public void registrarHorarioLocal(HorarioLocalDomain horarioLocal) {
        HorarioLocalEntity horarioLocalEntity = null;
        factory.getHorarioLocalDAO().create(horarioLocalEntity);
    }

    @Override
    public void modificarHorarioLocal(HorarioLocalDomain horarioLocal, UUID id) {
        HorarioLocalEntity horarioLocalEntity =null;
        factory.getHorarioLocalDAO().update(id, horarioLocalEntity);
    }

    @Override
    public List<HorarioLocalDomain> consultarDisponibilidadHorario(HorarioLocalDomain filtro) {
